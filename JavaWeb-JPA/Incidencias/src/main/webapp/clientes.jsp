...
<td>
	...
	<p> *ID: <input type="text" name="clienteId"> </p>
	<p> *Nombre: <input type="text" name="clienteNombre"> </p>
    <p> *Direccion: <input type="text" name="clienteDireccion"> </p>
    <p> Telefono: <input type="text" name="clienteTelefono"> </p>
